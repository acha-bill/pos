...
const CustomersPage = (props) => {
  ...
  const [isNewCustomerModalVisible, setNewCustomerModalVisible] =
    useState(false);
  const [isEditCustomerModalVisible, setEditCustomerModalVisible] =
    useState(false);
  const [isPayDebtModalVisible, setPayDebtModalVisibile] = useState(false);
  const [isBasketDetailModalVisible, setBasketDetailModalVisible] =
    useState(false);
  const [isViewDebtPaymentsModalVisible, setViewDebtPaymentsModalVisible] =
    useState(false);
        ...
        <div className="row">
          <div className="col-md-7">
            <div className="row ml-0 my-3 d-flex justify-content-start align-items-center">
              ...
              <div className="">
                ...
                >
                  ...
                  <span className="h5 ml-3">New Customer</span>
                </button>
              </div>
            </div>
            ...
            {isLoading ? (
              <div class="d-flex justify-content-center align-items-center">
                <div
                  ...
                  style={{ width: "3rem", height: "3rem", color: "#2980B9" }}
                  role="status"
                >
                    ...
                    Cell: (customer) => {
                      return (
                        <div>
                          ...
                          {customer.original.debt > 0 && (
                            <button
                              onClick={() => payDebt(customer.original)}
                  ...
                  },
                  {
                    ...
                    Cell: (customer) => {
                      return (
                        <div>
                          <span
                            onClick={() => viewTransactions(customer.original)}
                            className="mr-4 table-icons"
                          >
                            <VisibilityIcon style={{ fontSize: 20 }} />
                          </span>
                          <span
                            onClick={() => viewDebtPayments(customer.original)}
                            className="mr-4 table-icons"
                          >
                            <PaymentIcon style={{ fontSize: 20 }} />
                          </span>
                          <span
                            onClick={() => editCustomer(customer.original)}
                            className="mr-4 table-icons"
                          >
            ...
            {isViewDebtPaymentsModalVisible && (
              <DebtPayments
                setViewDebtPaymentsModalVisible={() =>
                  setViewDebtPaymentsModalVisible(false)
                }
                isViewDebtPaymentsModalVisible={isViewDebtPaymentsModalVisible}
            ...
            {isBasketDetailModalVisible && (
              <BasketDetail
                setBasketDetailModalVisible={() =>
                  setBasketDetailModalVisible(false)
                }
                isBasketDetailModalVisible={isBasketDetailModalVisible}
                basket={basket}
              />
            )}
          </div>
          <div className="col-md-5">
            <div className="pd">
              {!selectedCustomer && (
                <span>Transactions for selected customer will show here</span>
              )}
              {selectedCustomer && (
                <span>Transactions for: {selectedCustomer.name} </span>
              )}
                      ...
                      Cell: (customer) => {
                        return (
                          <div>
                            <span
                              onClick={() =>
                                viewBasketDetail(customer.original)
                              }
                              className="mr-4 table-icons"
                            >
                              <VisibilityIcon style={{ fontSize: 20 }} />
    ...
    >
      ...
      <div className="d-flex justify-content-between align-items-center mt-4 mx-5">
        ...
        <button
          ...
          className="btn btn-success mr-2"
        >
          <span className="h5 px-2">Update</span>
        </button>
      </div>
    </ActionModal>
  );
  ...
  return (
    ...
    >
      ...
      <div className="mx-5">
        <div className="d-flex justify-content-between align-items-center mb-4">
          <div>
            <span className="w-25 text">Amount</span>
          </div>
          <input
            name="amount"
            placeholder=""
      ...
      <div className="mx-5">
        <div>
          <span className="w-25 text">Balance: {balance} XAF</span>
        </div>
      </div>
      <div className="d-flex justify-content-between align-items-center mt-4 mx-5">
        <button
        ...
        <button
          ...
          className="btn btn-success mr-2"
        >
          <span className="h5 px-2">Pay</span>
        </button>
      </div>
    </ActionModal>
  );
...
const BasketDetail = (props) => {
  const { setBasketDetailModalVisible, isBasketDetailModalVisible, basket } =
    props;
