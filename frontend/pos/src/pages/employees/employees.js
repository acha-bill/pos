...
const Employees = (props) => {
  ...
  const handleSearchInput = (event) => {
    ...
    let filteredEmployees = nonRetiredEmployees.filter(
      (e) =>
              ...
              },
              {
                ...
                Cell: (employee) => {
                  return (
                    <div>
                      <span
                        onClick={() => editEmplyee(employee.original)}
                        className="mr-4 table-icons"
                      >
                        <Create style={{ fontSize: 20 }} />
                      </span>
                      <span
                        onClick={() => deleteAlert(employee.original)}
...
const NewEmployee = (props) => {
  ...
  return (
    <ActionModal
      isVisible={newEmployeeModal}
      setIsVisible={() => setNewEmployeeModalVisible(false)}
      title="New Employee"
    >
      <div className="mx-5">
        <div className="d-flex justify-content-between align-items-center mb-4">
          <div>
            <span className="w-25 text h6">
          ...
          <div className="d-flex justify-content-center align-items-center w-75">
            <Form.Group className={"w-75 m-0"}>
              <Form.Control
                ...
                as="select"
                className={"form-control input align-self-center m-0"}
              >
            ...
            <button
              onClick={() => addToRoles(role)}
              className="btn btn-primary text-center w-25 ml-2"
            >
      ...
      <div className="d-flex justify-content-around align-items-center mt-4 mx-5">
        ...
        >
          <span className="h5 px-2">Sumit</span>
        </button>
      </div>
    </ActionModal>
  );
...
const EditEmplyee = (props) => {
  const { setEditModalVisible, editModal, user, getEmployees, listOfRoles } =
    props;
