...
const StockMovement = (props) => {
  ...
  const getItems = async () => {
    ...
    res.forEach((item) => {
      if (item.stockMovements) {
        let mvnts = item.stockMovements.filter(
          (m) =>
  ...
  const handleSearch = (e) => {
    ...
    let res = movements.filter(
      (i) => i.item.name.toLowerCase().indexOf(key) >= 0
    );
    ...
    <div>
      <div className="text-center mt-2 mb-2">
        ...
        <div className="mt-2 mb-2">
          ...
          &nbsp;{" "}
          <button className="btn btn-sm btn-primary" onClick={getItems}>
            Refresh
        ...
        <div>
          ...
          <div id="print">
            <div className="text-center mb-2">
              ...
              <span>
                Photocopy report: {startDate.toLocaleDateString()} -{" "}
